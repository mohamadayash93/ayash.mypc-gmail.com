...
@push('script')
    <script>
        $('.btn-delete').on('click', function () {
            ...
            $('#delete-modal-message').html("{{html_entity_decode(trans('app.delete message'))}}");
            $('#warning-modal-message').html("{{html_entity_decode(trans('app.warning message'))}}");
        });
    </script>
@endpush