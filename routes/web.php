...
Route::group(
    ...
    Route::group([], function () {
        ...
        Route::get('/addToFavorite/{id}', 'GifController@addToFavorite')->name('gifs.addToFavorite');
        Route::get('/deleteFromFavorite/{id}', 'GifController@deleteFromFavorite')->name('gifs.deleteFromFavorite');
